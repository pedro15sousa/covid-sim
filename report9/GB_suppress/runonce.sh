...
do
    ...
    echo ../../build/src/CovidSim /c:54 /PP:preGB_R0=2.0.txt /P:p_NoInt.txt /CLP1:100000 /CLP2:0 /O:NoInt_R0=${R} /D:../population/GB_pop2018_nhs.txt /M:../population/GB_pop2018.bin /S:../population/NetworkGB_54T.bin /R:${rs} 98798150 729101 17389101 4797132
done
